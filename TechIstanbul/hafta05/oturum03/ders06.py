...
def form_doldurma():
    ...
    try:
        ...
        #     radiogender.click()
        driver.execute_script("document.getElementById('gender-radio-1').click();") # => JS kodu çalıştırma
        time.sleep(1)
