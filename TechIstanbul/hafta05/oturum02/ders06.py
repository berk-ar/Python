...
def scrape_bbc_news_updated():
    ...
    try:
        ...
        selectors = [
            "div[data-testid='promo'] p",
            #"h2[data-testid='card-headline']",  # Yeni BBC selector => BBC News
            #"a[data-testid='internal-link'] h2", # Alternatif selector => BBC News
            #"h3[class*='promo-heading']",       # Eski selector (yedek) => BBC News
            #"h2",                               # Tüm h2'ler (son çare) => BBC News
        ]
